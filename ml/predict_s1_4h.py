...
def main():
    ...
    try:
        ...
        s1_ativo    = int(rot_score >= 60.0 and dir_long and above_4h_open and prob >= ML_THR)
        s1_parcial  = int(rot_score >= 60.0 and dir_long and above_4h_open)  # sem ML
